...
echo "[4/9] Install Java (Jenkins requirement)"
sudo apt-get install -y fontconfig openjdk-17-jre

echo "[5/9] Install Jenkins"
...
echo "[8/9] Start Minikube with Docker driver"
minikube start --driver=docker
minikube addons enable ingress

echo "[9/9] Allow Jenkins to use Docker + kubeconfig"
